      ...
      <div class="row mt-lg-n10 mt-md-n11 mt-n10 justify-content-center">
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <div>
                <argon-input id="name" type="text" placeholder="Name" v-model="name" aria-label="Name" />
                <argon-input id="email" type="text" placeholder="Email" v-model="count" aria-label="Email" />

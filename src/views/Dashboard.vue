                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-12">
                        <mini-statistics-card
                            title="Today's Money"
                            description=" <span
              class='text-sm font-weight-bolder text-success'>+55%</span> since yesterday"
                            :icon="{
                            ...
                            :categories="[
                                {
                                    ...
                                    label: 'Devices',
                                    description:
                                        '250 in stock <strong>346+ sold</strong>',
                                },
                                {
                                    icon: {
                                        component: 'ni ni-tag',
                                    ...
                                    label: 'Tickets',
                                    description:
                                        '123 closed <strong>15 open</strong>',
                                },
                                {
                                    icon: {
                                    ...
                                    label: 'Error logs',
                                    description:
                                        '1 is active <strong>40 closed</strong>',
                                },
                                {
                                    icon: {
